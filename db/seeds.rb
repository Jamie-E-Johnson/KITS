CLASSIFICATIONS = ['Freshman', 'Sophomore', 'Junior', 'Senior', 'Grad Student']
...
100.times do
  Intern.create(
   ...
   school_congress_district:rand(25).to_s+","+ Faker::AddressUS.state_abbr,
   home_congress_district:rand(25).to_s+","+ Faker::AddressUS.state_abbr,
   classification: CLASSIFICATIONS[rand(5)]
  )
end
